...
namespace ResumeBuilder.Migrations
{
    ...
    [Migration("20230412173256_DonationTransUpdate009")]
    partial class DonationTransUpdate009
    {
            ...
            modelBuilder.Entity("ResumeBuilder.Models.DomainModels.ProjCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 4, 12, 22, 32, 55, 868, DateTimeKind.Local).AddTicks(6070),
                            DisplayOrder = 0
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 4, 12, 22, 32, 55, 868, DateTimeKind.Local).AddTicks(6433),
                            DisplayOrder = 0
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 4, 12, 22, 32, 55, 868, DateTimeKind.Local).AddTicks(6442),
                            DisplayOrder = 0
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 4, 12, 22, 32, 55, 868, DateTimeKind.Local).AddTicks(6444),
                            DisplayOrder = 0
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 4, 12, 22, 32, 55, 868, DateTimeKind.Local).AddTicks(6446),
                            DisplayOrder = 0
                        });
                });
